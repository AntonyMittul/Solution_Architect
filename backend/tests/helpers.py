...
def make_walking_skeleton_container(clock: Clock) -> Container:
    ...
    return Container(
        ...
        usage_service=unwired,
        list_mcp_servers=unwired,
        register_mcp_server=unwired,
        update_mcp_server=unwired,
        delete_mcp_server=unwired,
        discover_server_tools=unwired,
        create_provisioning_plan=unwired,
        list_provisioning_plans=unwired,
        get_provisioning_plan=unwired,
        approve_provisioning_plan=unwired,
        reject_provisioning_plan=unwired,
        audit=unwired,
    )
